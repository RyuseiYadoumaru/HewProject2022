#include "World2StageSelectScene.h"

using namespace Create;

bool GamePlay::World2StageSelectScene::Start()
{
	//オブジェクト生成 初期化
	//フェード
...
Scene::STATE GamePlay::World2StageSelectScene::Update()
{
	ObjectUpdate();
...
bool GamePlay::World2StageSelectScene::End()
{
	/*	オブジェクト終了処理	*/
	ObjectEnd();
...
bool GamePlay::World2StageSelectScene::Render()
{
	/****	画面クリア	****/
	ClearDisplay();
...
void GamePlay::World2StageSelectScene::RightMove(STAGE_NUMBER stage)
{
...
void GamePlay::World2StageSelectScene::LeftMove(STAGE_NUMBER stage)
{
