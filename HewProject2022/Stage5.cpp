...
bool GamePlay::Stage5Scene::Start()
{
	...
	m_LayerBack->Sprite("World1_obj1-5");
	m_GrayBack = Instance<GrayBack>("GrayBack");
	m_GrayBack->Sprite("Grey1-5");
	...
	m_ResultCursor->NowScene = "Stage5";//現在のシーン設定
