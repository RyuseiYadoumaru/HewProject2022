...
void DefaultAnim::Init()
{
	...
	s_LeftWalk.SetKey(0.0f, 100.0f, 200.0f, 300.0f);
	...
	s_RightWalk.SetKey(0.0f, 100.0f, 200.0f, 300.0f);
	...
	s_UpWalk.SetKey(0.0f, 100.0f, 200.0f, 300.0f);
	...
	s_DownWalk.SetKey(0.0f, 100.0f, 200.0f, 300.0f);
